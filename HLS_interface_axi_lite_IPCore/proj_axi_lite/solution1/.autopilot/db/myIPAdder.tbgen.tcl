...
set C_modelName {myIPAdder}
set C_modelType { void 0 }
set C_modelArgList {
	{ number_1 int 32 regular {axi_slave 0}  }
	{ number_2 int 32 regular {axi_slave 0}  }
	{ sum int 32 regular {axi_slave 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "number_1", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "number_1","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "number_2", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "number_2","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":24}, "offset_end" : {"in":31}} , 
 	{ "Name" : "sum", "interface" : "axi_slave", "bundle":"BUS_A","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "sum","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"out":32}, "offset_end" : {"out":39}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_BUS_A_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "BUS_A", "role": "AWADDR" },"address":[{"name":"myIPAdder","role":"start","value":"0","valid_bit":"0"},{"name":"myIPAdder","role":"continue","value":"0","valid_bit":"4"},{"name":"myIPAdder","role":"auto_start","value":"0","valid_bit":"7"},{"name":"number_1","role":"data","value":"16"},{"name":"number_2","role":"data","value":"24"}] },
	...
	{ "name": "s_axi_BUS_A_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "BUS_A", "role": "ARADDR" },"address":[{"name":"myIPAdder","role":"start","value":"0","valid_bit":"0"},{"name":"myIPAdder","role":"done","value":"0","valid_bit":"1"},{"name":"myIPAdder","role":"idle","value":"0","valid_bit":"2"},{"name":"myIPAdder","role":"ready","value":"0","valid_bit":"3"},{"name":"myIPAdder","role":"auto_start","value":"0","valid_bit":"7"},{"name":"sum","role":"data","value":"32"}, {"name":"sum","role":"valid","value":"36","valid_bit":"0"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "number_1", "Type" : "None", "Direction" : "I"},
			{"Name" : "number_2", "Type" : "None", "Direction" : "I"},
...
set ArgLastReadFirstWriteLatency {
	myIPAdder {
		number_1 {Type I LastRead 0 FirstWrite -1}
		number_2 {Type I LastRead 0 FirstWrite -1}
