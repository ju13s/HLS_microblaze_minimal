...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../microblaze.gen/sources_1/bd/design_1/ipshared/d0f7" \
       +incdir+"$ref_dir/../../../../microblaze.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../microblaze.gen/sources_1/bd/design_1/ipshared/d0f7" \
       +incdir+"../../../../microblaze.gen/sources_1/bd/design_1/ipshared/ec67/hdl"
}
